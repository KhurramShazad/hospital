...
if (isset($_POST['submit'])) {
	...
	$sql = mysqli_query($con, "Select doctors set specilization='$docspecialization',doctorName='$docname',address='$docaddress',docFees='$docfees',contactno='$doccontactno' where id='" . $_SESSION['id'] . "'");
	if ($sql) {
												...
												while ($data = mysqli_fetch_array($sql)) { ?>
													...
													<form role="form" name="adddoc" method="post" onSubmit="return valid();">
														<div class="form-group">
															...
															<p><?php echo htmlentities($data['specilization']); ?></p>
														</div>
														...
														<div class="form-group">
															...
															<p><?php echo htmlentities($data['doctorName']); ?></p>
														</div>
														...
														<div class="form-group">
															...
															<p><?php echo htmlentities($data['contactno']); ?></p>
														</div>
														...
														<div class="form-group">
															...
															<p><?php echo htmlentities($data['docEmail']); ?></p>
														</div>
													</form>
												<?php } ?>
											</div>
