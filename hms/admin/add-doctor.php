											...
											<div class="panel-body">
												...
												<form role="form" name="adddoc" method="post" onSubmit="return valid();">
													...
													<div class="form-group">
														...
														<input type="text" name="from_time" class="form-control" placeholder="Enter Doctor time" required="true">
													</div>
													<div class="form-group">
														<label for="doctorname">
															To time
														</label>
														<input type="text" name="to_time" class="form-control" placeholder="Enter Doctor time" required="true">
													</div>
